          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex items-center gap-4 mb-8" data-testid="social-share-icons">
              ...
              <button
                ...
                className="w-12 h-12 rounded-full border-2 border-red-400 flex items-center justify-center transition-transform hover:scale-110"
            ...
            >
              Voltar para página da campanha
            </button>
          </div>
        </div>
      </div>
