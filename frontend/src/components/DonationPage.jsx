    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Right Column - Initiative Info - Compact with more line breaks */}
          <div className="space-y-4 max-w-xl">
            ...
            {/* Title */}
            <h1 className="text-6xl md:text-7xl font-bold text-pink-500 mb-4" style={{ fontFamily: "'Nunito', sans-serif" }}>
              HUMUS
            </h1>

            {/* Description - First Part - Narrower to break into more lines */}
            <p className="text-lg text-gray-700 leading-relaxed max-w-lg" style={{ fontFamily: "'Nunito', sans-serif" }}>
            ...
            {/* Info Text - Second Part - Narrower to break into more lines */}
