...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 md:bg-white shadow-md" style={{ background: window.innerWidth < 768 ? 'linear-gradient(to right, #ec4899, #fb923c)' : 'white' }}>
